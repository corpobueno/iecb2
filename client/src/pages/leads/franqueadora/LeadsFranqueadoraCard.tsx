...
interface ILeadsFranqueadoraCardProps {
    row: ILeadsFranqueadora;
    handleOpenDetalhe?: (lead: ILeadsFranqueadora) => void;
    handleOpenComentarios: (lead: ILeadsFranqueadora) => void;
    showStatus?: boolean;
    statusColor: string;
}

export const LeadsFranqueadoraCard: React.FC<ILeadsFranqueadoraCardProps> = ({
    statusColor,
    showStatus = true,
    row,
...
const CardTextLucideIcon: React.FC<CardTextIconProps> = ({
    children,
    iconName,
    iconColor,
    textColor = '#444',
